...
def A_estrella_recorrido(coordenadas_nodo_inicial, objetivo):
    ...
    while nodo_mejor.padre:
        recorrido_final.append(nodo_mejor.coordenadas)
        nodo_mejor = nodo_mejor.padre
    
    

    recorrido_final_invertido = recorrido_final[::-1]
    recorrido_final_invertido = [coordenadas_nodo_inicial] + recorrido_final_invertido
    
        
    return(recorrido_final_invertido)
