...
def gameScreen():
    ...
    while run:
        ...
        for obstacle in obstacles:
            ...
            if playMode == 'm' or playMode == 'q' or playMode == 'a':
        ...
        if ((playMode == 'm' or playMode == 'q' or playMode == 'a') and player.alive == False):
            deathUpdates(player, obstacle)
        elif (playMode != 'm' and playMode != 'q' and playMode != 'a' and count_alive(population) == 0):
            countSurviving()
            currentGeneration()
        ...
        if (playMode != 'm' and playMode != 'q' and playMode != 'a'):
            countSurviving()
            currentGeneration()
...
def menu():
    ...
    if playMode == 'm' or playMode == 'q' or playMode == 'a':
        player.resetStatus()
    elif playMode != 'm' and playMode != 'q' and playMode != 'a' and callUpdateNetwork:
