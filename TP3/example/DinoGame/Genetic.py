...
def updateNetwork(population, bestScore):
    ...
    for i in range(len(population)-2):
        ...
        population[i+2].b1 = child[0]
        population[i+2].b2 = child[1]
        population[i+2].w1 = child[2]
        population[i+2].w2 = child[3]
        population[i+2].gen=population[i+2].gen+1
